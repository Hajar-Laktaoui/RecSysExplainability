...
# path = '/home/hajar.laktaoui/ImplementationFolder/PEPLER/UserEmbeddingsVF_all.pt'
...
model.to(device)
optimizer = AdamW(model.parameters(), lr=args.lr) #torch.optim.Adam(model.parameters(), lr=0.001)
